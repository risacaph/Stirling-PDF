<h1 align="center">Papyra — Self-Hosted PDF Platform</h1>

Papyra is a powerful, self-hosted PDF platform (a rebranded fork of [Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)). Run it in the browser or deploy it on your own servers with a private API. Edit, sign, redact, convert, and automate PDFs without sending documents to external services.
