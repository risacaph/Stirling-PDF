            ...
            <Box>
              ...
              <Text size="sm" c="dimmed" mt={2}>
                {t(
                  ...
                  "A new version of Papyra is ready to install.",
                )}
              </Text>
            </Box>
          </Group>
            ...
            >
              <Text size="sm">
                {t(
                  ...
                  "Papyra does not have permission to update itself on this machine.",
                )}{" "}
                <Anchor
            ...
            <Group justify="space-between" align="center">
              ...
              <Group gap="sm">
                <Text
                  size="sm"
                  component="a"
                  href={`https://github.com/risacaph/Papyra-PDF/releases/tag/v${updateSummary.latest_version}`}
                  target="_blank"
                  onClick={handleExternalLink(
                    `https://github.com/risacaph/Papyra-PDF/releases/tag/v${updateSummary.latest_version}`,
                  )}
                  c="blue"
                  style={{
                    textDecoration: "none",
                ...
                <Text
                  size="sm"
                  component="a"
                  href="https://github.com/risacaph/Papyra-PDF/releases"
                  target="_blank"
                  onClick={handleExternalLink(
                    ...
                    >
                      ...
                      >
                        ...
                        <Group gap={4}>
                          <Button
                            as="a"
                            href={`https://github.com/risacaph/Papyra-PDF/releases/tag/v${version.version}`}
                            target="_blank"
                            variant="tertiary"
                            size="sm"
                            onClick={handleExternalLink(
                              `https://github.com/risacaph/Papyra-PDF/releases/tag/v${version.version}`,
                            )}
                            rightSection={
